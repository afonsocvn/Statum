...
const { runElectionTick } = require('./lib/elections');
...
const ELECTION_TICK_INTERVAL_MS = Number(process.env.ELECTION_TICK_INTERVAL_MS) || 60 * 60 * 1000;
...
runElectionTick(db);
setInterval(() => runElectionTick(db), ELECTION_TICK_INTERVAL_MS);
